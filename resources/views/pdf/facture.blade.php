      ...
      <div class="container">
        ...
        >
          <div class="head-invoice">
            ...
            <div class="section-livraison">
              <h4 class="sub-title">
                N°Bon de pesée : <span style="margin-right: 30%;" class="capitalize"> 2903</span>
              Matricule vehicule: <span >{libraryName}</span>
            </h4>
              <h4 class="sub-title">
                N° de pv de constat de surcharge :
                <span style="margin-right: 20%;" class="capitalize"> 2903</span>Société : <span>{libraryPhone}</span>
              </h4>
              <h4>
                Nom et prénom du chauffeur : <span style="margin-right: 20%;">{libraryAddress}</span>
                Provenance : <span >{libraryAddress}</span>
              </h4>
              <h4>Destination : <span style="margin-right: 30%;">{libraryAddress}</span>
                Produit transporté : <span>{libraryAddress}</span></h4>
            </div>
          </div>
        </div>
        ...
        <div class="section-table">
          ...
          >
            ...
            <h3 style="margin-left: 50%; margin-top: 20px">Etabli a ndjole, le 23/09/2024</h3>
          </div>
        </div>
      </div>
