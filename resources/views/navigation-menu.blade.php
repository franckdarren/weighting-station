            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <h1 class="text-red-600 text-center border border-orange-400 bg-orange-400 w-[102px] py-5 me-2">
                            TPL</h1>
                    </a>
                ...
                @can('view pv')
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link href="{{ route('pv') }}" :active="request()->routeIs('pv')"
                            class="{{ request()->routeIs('pv') ? 'text-black' : 'text-white hover:text-gray-300' }}">
                            <i class="fa-solid fa-paste me-1"></i>
                            {{ __('PV') }}
                        </x-nav-link>
                    </div>
                ...
                @can('view rapports')
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <div x-data="{ open: false }" @click.away="open = false" class="relative inline-flex">
                            <button @click="open = !open"
                                class="inline-flex items-center px-1 pt-1 text-white text-sm hover:text-gray-300 focus:outline-none transition duration-150 ease-in-out">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                class="absolute z-50 mt-8 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                                <div class="rounded-md ring-1 ring-black ring-opacity-5 py-1">
                                    <a href="{{ route('rapport') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        {{ __('Journal d\'Activités') }}
                                    </a>
                                    <a href="{{ route('rapport-pesee') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        {{ __('Statistiques Pesees') }}
                                    </a>
                                    <a href="{{ route('rapport-facture') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        {{ __('Statistiques Factures') }}
                                    </a>
                                    <a href="{{ route('rapport-vehicule') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        {{ __('Statistiques Vehicules') }}
                                    </a>
                                    <a href="{{ route('rapport-entreprise') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        {{ __('Statistiques Entreprises') }}
                                    </a>
                                    <a href="{{ route('rapport-conducteur') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        {{ __('Statistiques Conducteurs') }}
                                    </a>
                                    <a href="{{ route('rapport-marchandise') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
