<div class="p-6 space-y-6">
    ...
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <h3 class="text-lg font-semibold mb-4">Distribution des produits transportés</h3>
                <div class="h-[300px]">
                    <canvas x-data="{
                        chart: null,
                        init() {
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <h3 class="text-lg font-semibold mb-4">Poids moyen par produit</h3>
                <div class="h-[300px]">
                    <canvas x-data="{
                        chart: null,
                        init() {
            ...
            <div class="bg-white rounded-lg shadow p-4 md:col-span-2">
                <h3 class="text-lg font-semibold mb-4">Évolution des produits transportés (Top 5)</h3>
                <div class="h-[300px]">
                    <canvas x-data="{
                        chart: null,
                        init() {
